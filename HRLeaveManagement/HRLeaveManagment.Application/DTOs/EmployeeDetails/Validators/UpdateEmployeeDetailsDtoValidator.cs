...
{
    public class UpdateEmployeeDetailsDtoValidator : AbstractValidator<UpdateEmployeeDetailsDto>
    {
        public UpdateEmployeeDetailsDtoValidator()
        {
            RuleFor(e => e.Id).NotNull().WithMessage("{PropertyName} must be present");
